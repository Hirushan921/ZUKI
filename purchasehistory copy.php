                            ...
                            ?>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-1 bg-danger ">
                                        ...
                                        <div class="col-12 col-lg-2 text-center text-lg-end bg-danger">
                                        ...
                                        <div class="col-12 col-lg-3">
                                            <div class="row">
                                                <div class="col-6 d-grid">
                                                    <button class="btn btn-secondary rounded border border-1 border-danger mt-5 fs-5" onclick="addFeedback(<?php echo $pid ?>);"><i class="bi bi-info-circle-fill"></i> Feedback</button>
                                                </div>
                                                <div class="col-6 d-grid">
                                                    <button class="btn btn-success rounded mt-5 fs-5" onclick="deletePHistory('<?php echo $ir['order_id'] ?>');"><i class="bi bi-trash-fill"></i> Delete</button>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-12 mb-3">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-2 d-grid">
                                <button class="btn btn-success fs-5"><i class="bi bi-trash-fill"></i> Clear All Records</button>
                            </div>
                        </div>
                    </div>
